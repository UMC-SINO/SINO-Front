...
export const NSCard = ({ card, onEdit, onDelete }: NSCardProps) => {
  return (
    <div className='relative group w-[88px] h-[88px] rounded-lg overflow-hidden bg-black border border-white'>
      {card.image ? (
      ...
      <div className='absolute top-1 right-1 flex gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity'>
        {onDelete && (
          <button onClick={onDelete} title='Delete' className='p-0. rounded'>
